...
import com.kidsstores.fbnativeads.databinding.NativeAdLayoutBinding;
import com.kidsstores.fbnativeads.databinding.RowItemBinding;
 ...
 */
public class New_Adapters extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public New_Adapters(Context context, List<Object> objectList, int ListSize) {
        this.context = context;
        this.objectList = objectList;
        int no_of_ad_req = ListSize / (AD_POSITION_EVERY_COUNT - 1);
        nativeAdsManager = new NativeAdsManager(context, "IMG_16_9_APP_INSTALL#YOUR_PLACEMENT_ID", no_of_ad_req);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ADS_TYPE) {
            ...
            return new MainAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.row_item, parent, false));
